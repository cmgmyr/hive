...
// two-space anchor was added to close, where a bare-name matcher also matched the still-going
// roster - "was this worker reported" and "is this worker merely alive
