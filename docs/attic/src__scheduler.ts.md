# Attic: src/scheduler.ts

Comments removed from `src/scheduler.ts` by todo 436, verbatim. Line numbers are
...
```
// filesystem root; existsSync(projectPath) should stop this first
```
