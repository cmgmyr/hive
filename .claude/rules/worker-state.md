...
## Four ways worker state has been wrong, and how each was closed

Same class each time: hive reported something it could not observe, or had the fact and did not say it plainly. The fourth is the odd one out and worth reading for the difference: there the state was **correct** and the meaning read off it was not.
